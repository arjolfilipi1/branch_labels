...
class PrintSettingsDialog(QDialog):
    ...
    def save_settings(self):
        ...
        SETTINGS.setValue("app/dpi", self.dpi_edit.value())
        SETTINGS.setValue("print/width", self.width_edit.value())
        SETTINGS.setValue("print/height", self.height_edit.value())
        SETTINGS.setValue("print/offset", self.offset_edit.value())
    ...
    def print_pdf_natively(self,pdf_path):
        if self.simple_print:
            try:
                ...
                print(f"Sending to printing failed: {str(e)} {i}")
        else:
            ...
            for i in range(len(doc)):
                try:
                    ...
                    print(f"Printing page {i + 1} of type { type(image) }")
    ...
    def print_pdf(self,data_list, output_pdf,nr_copies,use_qr):
        ...
        try:
                ...
                for index, item in enumerate(data_list):
                    ...
                    if use_qr:
                        try:
                            ...
                            c.showPage()
                            print(f"creating page of type { type(c) }")
                        except Exception as e:
            ...
            # os.startfile(temp_pdf_path, 'print')
                ...
                print(f"Printing failed before: {str(e)}",temp_pdf_path)
        except Exception as e:
            print(f"Printing failed: {str(e)}",temp_pdf_path)
        finally:
            try:
